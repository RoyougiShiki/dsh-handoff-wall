/**
 * @dsh-external/dsh-handoff-board — 守护循环形态（由 dev_scaffold_plugin 生成）。
...
export const name = "@dsh-external/dsh-handoff-board"
...
export function apply(ctx: AppContext, config: Config): void {
  ...
  ctx.logger?.info?.('[' + "@dsh-external/dsh-handoff-board" + '] 守护循环启动（每 ' + config.intervalMs + 'ms 一轮）')
}
